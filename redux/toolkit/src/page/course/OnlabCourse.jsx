...
import { useGetListOfflineCourseQuery } from '../../app/service/CourseService';

function OnlabCourse() {
    const { data, isLoading, isError, error } = useGetListOfflineCourseQuery();
